...
const renderExcludedKeyButton = (
  ...
  const isEnter = keyType === "Enter";

  const buttonLabel = isEnter ? (
    "Enter"
  ) : (
    <svg
      width="36"
...
export default renderExcludedKeyButton;
